...
-- salvar_dados_usuario: REMOVIDA em 2026-08-15 (migration 20260815200000).
-- RPC orfa, SECURITY DEFINER, sem chamador em lugar nenhum. NAO recriar:
-- era um caminho de escrita em user_data a um GRANT de distancia de
-- contornar MFA, merge por perfil, anti-wipe, trava de versao e o teto.

-- salvar_perfil_usuario: REMOVIDA em 2026-08-15 (migration 20260815200000).
-- RPC orfa, SECURITY DEFINER, sem chamador em lugar nenhum. NAO recriar:
-- era um caminho de escrita em user_data a um GRANT de distancia de
-- contornar MFA, merge por perfil, anti-wipe, trava de versao e o teto.
