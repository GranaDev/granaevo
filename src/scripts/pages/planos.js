...
// CARROSSEL DE PLANOS — removido em 2026-07-19.
// initCarousel()/goToSlide() moviam os cards por `transform`. O layout migrou para
// scroll-snap CSS (scroll-snap-type: x mandatory) + scrollToFeaturedCard(), que rola
// nativamente — e os elementos que o JS esperava (#carouselIndicators, #prevBtn,
// #nextBtn) nao existem mais no HTML. As duas ficaram declaradas e NUNCA chamadas;
// liga-las faria transform brigar com o snap nativo.
// planCardsArray/totalSlides continuam vivos — o resize handler e o boot os usam.
